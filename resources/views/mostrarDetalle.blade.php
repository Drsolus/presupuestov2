			...
			<table class="table table-hover table-condensed table-bondered">
				...
				<tbody>
					<tr>
						...
						<td><input placeholder="Ingrese valor a aprobar" type="number" name="valoraAprobar"></td>
						<td><button class="btn btn-success glyphicon glyphicon-ok">Aprobar</button></td>
						<td><button class="btn btn-danger glyphicon glyphicon-remove">Rechazar</button></td>
					</tr>
				</tbody>
				@endforeach
			</table>
